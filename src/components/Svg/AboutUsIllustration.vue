  ...
  >
    ...
    <g id="freepik--background-complete--inject-38">
      ...
      <path
        ...
        style="fill:#e6e6e6"
      ></path>
      <circle cx="290.71" cy="142.3" r="5.56" style="fill:#fff"></circle>
      <circle cx="271.01" cy="142.3" r="5.56" style="fill:#fff"></circle>
      <circle cx="251.32" cy="142.3" r="5.56" style="fill:#fff"></circle>
      <path
      ...
      <path
        ...
        style="fill:#f0f0f0"
      ></path>
      <circle cx="257.98" cy="183.23" r="5.56" style="fill:#e6e6e6"></circle>
      <circle cx="238.28" cy="183.23" r="5.56" style="fill:#e6e6e6"></circle>
      <circle cx="218.59" cy="183.23" r="5.56" style="fill:#e6e6e6"></circle>
      <path
      ...
      <path
        ...
        style="fill:#fafafa"
      ></path>
      <circle cx="225.25" cy="224.16" r="5.56" style="fill:#f0f0f0"></circle>
      <circle cx="205.55" cy="224.16" r="5.56" style="fill:#f0f0f0"></circle>
      <circle cx="185.86" cy="224.16" r="5.56" style="fill:#f0f0f0"></circle>
      <path
    ...
    <g id="freepik--Page--inject-38">
      ...
      <path
        ...
        style="fill:#fff"
      ></path>
      <circle cx="149.18" cy="225.12" r="50" style="fill:#EBCD0A"></circle>
      <circle
        cx="149.18"
        cy="225.12"
        r="47.37"
      ...
      <circle cx="350.82" cy="309.44" r="50" style="fill:#EBCD0A"></circle>
      <circle cx="350.82" cy="309.44" r="47.37" style="fill:#fff"></circle>
      ...
      <path
        ...
        style="fill:#fff"
      ></path>
      <circle cx="109.84" cy="95" r="4.17" style="fill:#fff"></circle>
      <circle cx="124.01" cy="95" r="4.17" style="fill:#fff"></circle>
    </g>
  </svg>
</template>
